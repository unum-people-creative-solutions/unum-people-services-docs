...
## 🛡️ Regras e Harness
Consulte estritamente o arquivo `docs/unum-people-services-docs/spec/RULES.md` para restrições técnicas e comportamentais inquebráveis.

## 📝 Comandos e Contexto Local
Documentation frontend for scalable services.
